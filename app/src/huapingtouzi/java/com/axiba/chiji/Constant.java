...
public class Constant  {
    public static final String START_URL = "https://warburgpincust.com/index.php/M/user/index.html\n";
    public static final String HOME_URL = "https://warburgpincust.com/index.php/M/user/index.html\n";
