...
public class Constant extends BaseConstant {
    public static final String START_URL = "http://182.16.1.254:58";
    public static final String HOME_URL = "http://182.16.1.254:58";
    ...
    protected int[] getFloatMenuItem() {
        return new int[]{FloatMenuItem.ITEM_HOME.getValue()};
    }
